...
exports.config = {
    ...
    path_public: "/home/server/apps/public/primitive-web",
    test: {
...
const Router = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/es/index.js");
const board_page_1 = __webpack_require__(/*! ./pages/board.page */ "./src/pages/board.page.tsx");
const home_page_1 = __webpack_require__(/*! ./pages/home.page */ "./src/pages/home.page.tsx");
const write_post_page_1 = __webpack_require__(/*! ./pages/write-post.page */ "./src/pages/write-post.page.tsx");
class App extends React.Component {
    render() {
        return (React.createElement("div", { className: "router-wrapper" },
            React.createElement(Router.Route, { exact: true, path: "/", component: home_page_1.HomePage }),
            React.createElement(Router.Route, { path: "/board", component: board_page_1.BoardPage }),
            React.createElement(Router.Route, { path: "/write", component: write_post_page_1.WritePostPage })));
    }
}
exports.App = App;
...
class LoginForm extends React.Component {
    constructor(props) {
        ...
        this.onLoginClicked = () => {
            ...
            console.log("ID: " + id);
            console.log("PW: " + pw);
            reqUser.UserAPIRequest.loginUser(id, pw)
            ...
            React.createElement("div", { className: "row" },
                React.createElement("form", { className: "col" },
                    React.createElement("div", { className: "form-group" },
                        React.createElement("label", { ref: "usernameLabel" }, "ID"),
                        React.createElement("input", { id: "username", type: "text", className: "form-control", placeholder: "\uD559\uBC88", "aria-label": "Username" })),
                    React.createElement("div", { className: "form-group" },
                        React.createElement("label", { ref: "passwordLabel" }, "PW"),
                        React.createElement("input", { id: "password", type: "password", className: "form-control", placeholder: "Password", "aria-label": "Password" }))),
                React.createElement("button", { type: "submit", className: "btn text-white bg-primary col-2 my-5 mx-3 px-2", onClick: this.onLoginClicked }, "LOGIN"))));
    }
}
...
ReactDOM.render(React.createElement(Router.BrowserRouter, null,
...
UserAPIRequest.registerUser = (user, pw) => {
    return axios_1.default.post(config_1.config.url + "/api/v1/user/register", {
        name: user.getName(),
        sid: user.getSid(),
        password: pw,
        role: user.getRole(),
...
UserAPIRequest.loginUser = (id, pw) => {
    return axios_1.default.post(config_1.config.url + "/api/v1/auth/login", {
        id,
        pw,
    });
};
UserAPIRequest.logoutUser = () => {
    return axios_1.default.get(config_1.config.url + "/api/v1/auth/logout");
};
UserAPIRequest.checkSignedIn = () => {
    return axios_1.default.get(config_1.config.url + "/api/v1/auth/check");
};
exports.UserAPIRequest = UserAPIRequest;
...
const React = __webpack_require__(/*! react */ "react");
const ReactRouter = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/es/index.js");
const reqUser = __webpack_require__(/*! ../lib/user.request */ "./src/lib/user.request.ts");
class BoardPage extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", null,
            ...
            React.createElement("h1", { className: "board-title" }),
            React.createElement(ReactRouter.Link, { to: "/" }, "Home"),
            React.createElement(ReactRouter.Link, { to: "/write" },
                React.createElement("button", { className: "btn" }, "\uAE00\uC4F0\uAE30")),
            React.createElement("button", { className: "btn", onClick: this.onLogout }, "logout")));
    }
}
...
class HomePage extends React.Component {
    render() {
        return (React.createElement("div", { className: "home-wrapper d-flex flex-column justify-content-center" },
            React.createElement("img", { src: "/img/primitive_logo.svg", alt: "logo", className: "home-logo mx-auto mb-5" }),
            React.createElement("div", { className: "home-login-box mx-auto mt-5 px-4 py-3" },
                React.createElement(login_form_component_1.LoginForm, null))));
    }
}
